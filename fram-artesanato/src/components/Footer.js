...
const Rodape = () => {
  ...
  const contatos = [
    ...
    { tipo: "E-Mail", href: "mailto:framartesanatos00@gmail.com?subject=Duvida&body=Gostaria de saber mais sobre seus serviços.", numero: "franartesanatos00@gmail.com", imgSrc: "/images/pages/index/icon_footer (2).png" },
    {
    ...
    <footer className="rodape">
      ...
      <div className="titulo__sub">
        <h1 className="cabecalho__nav__titulo titulo__rodape">
          <Link to="/"><b className="titulo_destaque">Fran</b> Artesanatos</Link>
        </h1>
        <p className="rodape__descricao">
          Fran Artesanatos - Nascida do hobby de uma pequena empreendedora, nossa loja transforma sonhos em
      ...
      <div className="rodape__creditos">
        <p className="creditos1">@ 2024 Fran Artesanatos</p>
